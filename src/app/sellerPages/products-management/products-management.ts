  ...
  loadProducts(): void {
    ...
    this.productService.getBySellerId(sellerId).subscribe({
      ...
      error: (error) => {
        ...
        this.toastService.showError(this.getTranslation('loadProductsError'));
        this.isLoading = false;
      }
    });
  }
  ...
  loadServicesAndThenProducts(): void {
    ...
    this.serviceService.getBySeller().subscribe({
      ...
      error: (error) => {
        ...
        this.toastService.showError(this.getTranslation('loadServicesError'));
        this.isLoading = false;
      }
    });
  }
  ...
  saveProduct(): void {
    ...
    saveObservable.subscribe({
      ...
      error: (error) => {
        ...
        this.toastService.showError(this.getTranslation('saveProductError'));
        this.isLoading = false;
        if (form) {
          form.querySelectorAll('input, select, textarea, button').forEach((element: any) => {
